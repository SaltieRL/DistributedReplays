...
player_stats_metadata = [
    # Hits
    Metadata('hits', ChartType.bar, SubCat.Hits),
    Metadata('average_hit_distance', ChartType.bar, SubCat.Hits),
    ...
    # Ball
    Metadata('time_close_to_ball', ChartType.bar, SubCat.Ball),
    Metadata('time_closest_to_ball', ChartType.pie, SubCat.Ball),
    Metadata('time_furthest_from_ball', ChartType.pie, SubCat.Ball),
    Metadata('time_behind_ball', ChartType.bar, SubCat.Ball),
    Metadata('time_in_front_ball', ChartType.bar, SubCat.Ball),
    ...
    # playstyles
    Metadata('average_speed', ChartType.bar, SubCat.Playstyles),
    Metadata('time_at_boost_speed', ChartType.bar, SubCat.Playstyles),
    Metadata('time_at_slow_speed', ChartType.bar, SubCat.Playstyles),
    Metadata('time_at_super_sonic', ChartType.bar, SubCat.Playstyles),
    ...
    Metadata('ballcam_percent', ChartType.bar, SubCat.Playstyles),
    ...
    # boost
    Metadata('boost_usage', ChartType.bar, SubCat.Boosts),
    Metadata('wasted_collection', ChartType.bar, SubCat.Boosts),
    Metadata('wasted_usage', ChartType.bar, SubCat.Boosts),
    ...
    Metadata('time_full_boost', ChartType.bar, SubCat.Boosts),
    Metadata('time_low_boost', ChartType.bar, SubCat.Boosts),
    Metadata('time_no_boost', ChartType.bar, SubCat.Boosts),
    ...
    Metadata('total_boost_efficiency', ChartType.bar, SubCat.Efficiency),
    Metadata('turnover_efficiency', ChartType.bar, SubCat.Efficiency),
    Metadata('shot_%', ChartType.bar, SubCat.Efficiency),
    Metadata('useful/hits', ChartType.bar, SubCat.Efficiency),
    Metadata('aerial_efficiency', ChartType.bar, SubCat.Efficiency),

    # team positioning
    Metadata('time_in_front_of_center_of_mass', ChartType.bar, SubCat.Team_Positioning),
    Metadata('time_behind_center_of_mass', ChartType.bar, SubCat.Team_Positioning),
