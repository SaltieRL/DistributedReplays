...
class HeatmapContentComponent extends React.PureComponent<Props> {
    ...
    private readonly createHeatmap = (
        player: ReplayPlayer // TODO: Standardise with ball heatmap above
    ) => (
        <Grid item key={player.name} xs={12} md={6} lg={4} style={{height: 375, minWidth: WIDTH, textAlign: "center"}}>
