...
import { ChartDataResponse } from "src/Models"
...
class PlayerPlayStyleChartComponent extends React.PureComponent<Props> {
    ...
    private readonly getChartData = (): ChartData => {
        ...
        const averageData = data[0].chartDataPoints.map(
            (chartDataPoint) => (chartDataPoint.average === undefined ? 0 : chartDataPoint.average)
        )
