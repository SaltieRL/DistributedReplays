                ...
                <Grid container justify="center">
                    <Grid item xs={12} lg={10} xl={8}>
                        <Grid container spacing={16} justify="center">
                            <div className="col-xl-8 col-lg-12 single-content">
                                <Typography>
                                    ...
                                    <h3>What data do we collect?</h3><p>Calculated.gg collects the following data:</p>
                                    <ul>
                                        <li>Uploaded replays</li>
                                    </ul>
                                    <h3>How do we collect your data?</h3><p>You directly provide Calculated.gg with
                                    ...
                                    <h3>How will we use your data?</h3><p>Calculated.gg collects your data so that we
                                    can:</p>
                                    <ul>
                                        <li>Provide the website's required services</li>
                                    </ul>
                                    <h3>How do we use cookies?</h3>
                                    <p>Calculated.gg uses cookies in a range of ways to improve your experience on our
                                        website, including:</p>
                                    <ul>
                                    ...
                                    <ul>
                                        <li>Functionality – Calculated.gg uses these cookies so that we recognize you
                                    ...
                                    <p>You can set your browser not to accept cookies or remove currently set cookies.
                                        For
                                        info, see <a href={"http://www.allaboutcookies.org"}>allaboutcookies.org</a>.
                                        However, in a few cases, some of our website features may not function as a
                                        result.</p>

                                    <h3>Privacy policies of other websites</h3>

                                    <p>The Calculated.gg website contains links to other websites. Our privacy policy
                                        applies only to
                                        our website, so if you click on a link to another website, you should read
                                        their privacy policy.</p>

                                    <h3>Changes to our privacy policy</h3>

                                    <p>The site keeps its privacy policy under regular review and places any updates
