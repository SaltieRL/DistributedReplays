...
export class LeaderboardsPage extends React.PureComponent<Props, State> {
            ...
            <BasePage>
                <Grid container spacing={3} justify="center">
                    <LoadableWrapper load={this.getLeaderboards}>
                        {this.state.leaderboards && <PlaylistLeaderboardGrid leaderboards={this.state.leaderboards} />}
                    </LoadableWrapper>
                </Grid>
            </BasePage>
        )
    ...
    private readonly getLeaderboards = (): Promise<void> => {
        return getLeaderboards().then((leaderboards) => this.setState({leaderboards}))
    }
}
