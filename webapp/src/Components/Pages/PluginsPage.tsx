                        ...
                        <Card>
                            ...
                            <CardContent>
                                <Typography paragraph>
                                    BakkesMod allows you to automatically save replays (among many other features). The
                                    plugin linked below allows you to automatically upload these replays so you get
                                    these amazing stats without any extra work!
                                </Typography>
                                <Typography>
                                    The autoupload feature can be enabled/disabled in-game under [F2] → [Plugins] →
                                    [Auto upload] and checking/unchecking "Automatically upload replays to
                                    calculated.gg".
                                </Typography>
                            </CardContent>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <Typography>
                                    ...
                                    GUID utilization to prevent uploading duplicate replays to the server, and various
                                    other tools to faciliate replay uploading.
                                </Typography>
                            </CardContent>
                            <CardActions style={{justifyContent: "flex-end"}}>
                                <LinkButton
                                    icon={OpenInNew}
                                    iconType="mui"
                                    to="https://github.com/Xylot/Vextra/releases/latest"
                                    isExternalLink
                                >
                                    Vextra
                                </LinkButton>
