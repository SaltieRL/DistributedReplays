...
var DracoDecoderModule = function(d) {
        ...
        if ("string" === typeof a) {
            for (var b = 0, c = 0; c < a.length; ++c) {
                ...
                127 >= e
                    ? ++b
                    : (b =
                          2047 >= e ? b + 2 : 65535 >= e ? b + 3 : 2097151 >= e ? b + 4 : 67108863 >= e ? b + 5 : b + 6)
            }
            b = Array(b + 1)
            c = 0
            e = b.length
    ...
    if (pa) {
        ...
        a.thisProgram ||
            (a.thisProgram = 1 < process.argv.length ? process.argv[1].replace(/\\/g, "/") : "unknown-program")
    ...
    var A = {
            ...
            decRef: function(e) {
                if (e) {
                    ...
                    0 !== b.refcount ||
                        b.rethrown ||
                        (b.destructor && a.dynCall_vi(b.destructor, e), delete A.infos[e], ___cxa_free_exception(e))
                }
            },
            clearRef: function(a) {
